    ...
    <div class="max-w-7xl mx-auto px-6">
      <div>
        ...
        <p class="text-white mt-5 leading-7">
          Las empresas que transformaron industrias entendieron algo antes que
          los demás: el verdadero valor no estaba únicamente en crear productos.
          Estaba en construir la infraestructura de distribución donde otros
          pudieran crecer.
        </p>
      </div>
      ...
      <div class="grid grid-cols-2 items-center gap-12 mt-20">
        <div class="cols-span-1">
          <p class="text-white leading-7">
            ...
            con márgenes mínimos. Son inquilinos perpetuos de la tecnología de
            otros.
          </p>
        </div>
        ...
        <div class="cols-span-1">
          <div class="border rounded-xl shadow-[0_0_30px_rgba(34,197,94,0.35)]  border-green-500 p-14">
            ...
            <p class="text-white leading-7 mt-10">
              ...
              fundadores, participes del crecimiento que genere todo el
              ecosistema.
            </p>
          </div>
        </div>
