  ...
  <section class="bg-black py-20">
    <div class="max-w-7xl mx-auto px-6">
      ...
      <p class="text-gray-400 mt-7 text-center">
        ...
        Partners, tu realidad profesional experimentará un cambio significativo
        ...
        <div class="bg-secondary border-gray-400 rounded-3xl px-8 py-12 mt-10">
          ...
          <div class="">
            ...
            <p class="text-gray-400 leading-7 mt-5">
              Liderarás las primeras Masterclass internacionales oficiales de la
              marca, posicionando tu marca personal frente a una comunidad
              hambrienta de guía.
            </p>
          </div>
        </div>
      ...
      <article class="bg-secondary px-20 py-20 rounded-4xl mt-10 relative">
        ...
        <p class="text-white text-center text-4xl leading-13 italic mt-10">
          "Dentro de un año... si eres uno de los cinco Founding Partners...
          podrás mirar atrás y recordar este momento como el día en que
          decidiste pasar de desarrollar únicamente tu proyecto personal a
          ayudar a construir un ecosistema con impacto regional. No podemos
          prometerte resultados automáticos; pero sí podemos prometerte que, si
          eres seleccionado, trabajarás desde el origen exacto de una iniciativa
          que aspira a transformar la forma en que el conocimiento se crea, se
